...
class PyPageIterator:
    ...
    def BoundingBox(self, level: RIL, padding: int = ...) -> typing.Tuple[int, int, int, int]:
    ...
    def GetImage(self, level: RIL, padding: int, original_image: PIL.Image) -> typing.Tuple[PIL.Image, int, int]:
    ...
    def Baseline(self, level: RIL) -> typing.Tuple[typing.Tuple[int, int], typing.Tuple[int, int]]:
    ...
    def Orientation(self) -> typing.Tuple[Orientation, WritingDirection, TextlineOrder, float]:
...
class PyTessBaseAPI:
    ...
    def InitFull(self, path: str=..., lang: str=...,
                 oem: OEM=OEM.DEFAULT, configs: typing.List=[],
                 variables: typing.Dict={}, set_only_non_debug_params: bool=False):
    ...
    def GetTextlines(self, raw_image: bool = False, raw_padding: int = 0,
                     blockids: bool = True, paraids: bool = False) -> typing.List[typing.Tuple[PIL.Image, typing.Dict, int, int]]:
    ...
    def GetStrips(self, blockids: bool = True) -> typing.List[typing.Tuple[PIL.Image, typing.Dict, int]]:
    ...
    def GetConnectedComponents(self) -> typing.List[typing.Tuple[PIL.Image, typing.Dict]]:
...
def image_to_text(image: PIL.Image, lang=..., psm: PSM = PSM.AUTO,
                  path=..., oem: OEM = OEM.DEFAULT) -> str:
...
def file_to_text(filename: str, lang=..., psm: PSM = PSM.AUTO,
                 path=..., oem: OEM = OEM.DEFAULT) -> str:
